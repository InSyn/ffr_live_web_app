...
export default {
  ...
  methods: {
    ...
    isSXQual(competition) {
      ...
      return competition.discipline_code === 'SX' && competition.stage.split(' ')[0].toLowerCase() === 'квалификация';
    },
    isSXFinal(competition) {
      if (!competition || !competition['races'].length || !competition.stage || !competition.discipline_code) return false;
      return competition.discipline_code === 'SX' && competition.stage.split(' ')[0].toLowerCase() === 'финал';
    },
    isDMO(competition) {
