    ...
    <div class="formBody">
      ...
      <div v-for="(_, field_key) in trainer" :key="field_key" class="formGroup">
        ...
        <select
          v-else-if="
            field_key === 'region' &&
            getCountryCode(trainer['country']) === 'RU'
          "
          :id="field_key"
          class="formControl"
          :value="trainer[field_key]"
        ...
        <div class="select__wrapper" v-else-if="field_key === 'disciplines'">
          ...
          >
            ...
            >
              <option
                v-for="discipline in getDisciplines(trainer['sport'])"
                :key="discipline.code"
              >
                {{ discipline.name_rus }}
              </option>
        ...
        >
          ...
          <option
            v-for="rank in trainerCategories"
            :key="rank"
            class="formControl-option"
          >
            {{ rank }}
        ...
        <multiple-string-control
          ...
          :placeholder="`${
            field_key === 'rank' ? 'Добавить звание' : 'Добавить должность'
          }`"
        ></multiple-string-control>
    ...
    previewImage(imageType, sourceType) {
      if (sourceType === "file" && this.selectedFile[imageType]) {
        ...
        this.$set(
          this.imagePreview,
          imageType,
          uploadsFolderUrl + this.trainerImages[imageType]
        );
      }
    },
