	...
	<div v-if="athlete" class="athletePage__wrapper">
		<div class="athleteCard__top__wrapper">
			...
			<div class="athleteCard__top__content">
				<div class="athleteInfo__wrapper bg-frozen-glass">
						...
						<div class="athleteMainInfo__wrapper">
							...
							<div class="athleteMainInfo__middle">
								<div class="athleteName__wrapper">
									...
									<div v-if="athlete['isNationalTeam']" class="nationalTeamLogo__wrapper">
										Сборная России
										<img
								...
								<athlete-medals :medals="athlete['medals']" />
							</div>
					...
					<div class="athleteAdditionalInfo__wrapper">
						<div class="athleteAdditionalInfoSection mainSection">
							...
							<div v-if="athlete.birthDate" class="athleteInfo__group">
								<b> Год рождения: </b>
								<span>
									{{ new Date(Date.parse(athlete.birthDate)).getFullYear() }}
								</span>
							</div>
					...
					<div class="athleteSocials__section">
						...
						<div v-if="athlete.socials" class="socials">
							<a
...
export default {
	...
	methods: {
		...
		async getAthleteById(id) {
			try {
				const response = await axios.get(apiUrl + '/athletes/' + id)
				if (response.status === 200) {
					const athleteData = response.data.athlete
					if (athleteData) this.athlete = { ...athleteData }
				}
