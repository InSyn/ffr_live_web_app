		...
		<div class="athlete__listItem__wrapper">
			...
			<div class="athleteInfo__bottom">
				<div class="personalInfo__wrapper">
					<div v-if="item.birth_date" class="personalInfo__item__wrapper athleteYear">
						<div class="personalInfo__item">
							<span>Год рождения:&nbsp;</span>
							<span>
								{{ item.birth_date ? formatBirthDate(item.birth_date) : '-' }}
							</span>
						</div>
					</div>

					<div v-if="item.category" class="personalInfo__item__wrapper athleteRank">
						<div class="personalInfo__item">
							<span>Разряд:&nbsp;</span>
							<span>{{ getShortAthleteRank(item.category) }}</span>
						</div>
					</div>

					<div v-if="item['regions'].length" class="personalInfo__item__wrapper athleteRegions">
						{{ concatStringsWithComma(item['regions']) }}
					</div>
				</div>
				...
				<div class="athleteSport__wrapper">
					...
					<div class="disciplines__wrapper">
						<div v-for="(dsc, idx) in item.disciplines" :key="idx + dsc" class="discipline__item">
