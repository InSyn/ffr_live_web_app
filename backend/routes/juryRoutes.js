...
import { authenticateToken, isAdmin, isSecretary } from '../middleware/authentication.js'
...
juryRouter
	...
	.post(
		authenticateToken,
		isAdmin,
		createMulterMiddleware([{ name: 'photo_url', maxCount: 1 }]),
		juryController.addNewJury
	)

juryRouter.route('/secretaries').get(juryController.getSecretaries)
...
juryRouter
	.route('/:code/set-secretary')
	.patch(authenticateToken, isSecretary, juryController.setSecretaryRole)
