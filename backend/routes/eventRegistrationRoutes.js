...
onlineRegistrationRouter
  ...
  .get(authenticateToken, hasRole('trainer', 'regional_organization'), eventRegistrationController.findRegisteredApplicationsByUser);

onlineRegistrationRouter
  .route('/registered-applications/:id')
  .get(authenticateToken, hasRole('trainer', 'regional_organization'), eventRegistrationController.getRegistrationById)
  .put(authenticateToken, hasRole('trainer', 'regional_organization'), createMulterMiddleware(multerFields), eventRegistrationController.updateRegistration)
  .delete(authenticateToken, hasRole('trainer', 'regional_organization'), eventRegistrationController.deleteRegistration);
